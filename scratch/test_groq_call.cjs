  ...
  const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
    ...
    body: JSON.stringify({
      ...
      messages: [
        ...
        {
          role: 'user',
          content: 'Analyze this sample admission form document for student "Aarav Mehta", school "Greenfield International School", DOB "12/05/2009", father "Vikram Mehta". Extract into extracted_data (student_name { raw, english }, document_date, key_attributes).'
        }
      ],
      temperature: 0.1,
